        ...
        <SubNavigationContainer>
            <SubNavigationBar>
                <SubNavigationBarItem >
                    <StyledLink activeclassname="active"  onClick={handleSubNavigation} to='/schedules/timberwolves'>Timberwolves</StyledLink>
                </SubNavigationBarItem>
                <SubNavigationBarItem >
                    <StyledLink activeclassname="active" onClick={handleSubNavigation} to='/schedules/lynx'>Lynx</StyledLink>
                </SubNavigationBarItem>
            </SubNavigationBar>
        </SubNavigationContainer>
